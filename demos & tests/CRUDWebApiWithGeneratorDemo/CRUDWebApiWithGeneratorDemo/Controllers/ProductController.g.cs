...
If you need to change the content for this entity, update the ProductController.cs file
...
This partial class is added with customized document comments that are fit for the linked type Product.

Any overriden logic should be done in the other part of the file, ProductController.cs.
...
public partial class ProductController
{
    ...
    /// <summary>
    ///     Retrieves the collection of records of type <see cref="Product" />.
    /// </summary>
    /// <response code="200">
    ///     The collection of records of type <see cref="Product" />.
    /// </response>
    /// <response code="401">
    ///     Unauthorized request to retrieve filtered collection of <see cref="Product" /> records.
    /// </response> 
    /// <response code="500">
