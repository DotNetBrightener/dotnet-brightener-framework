...
public static class ServiceCollectionExtensions
{
    ...
    extension(IServiceCollection serviceCollection)
    {
        ...
        /// </returns>
        public EfDataServiceConfigurator AddEFCentralizedDataServices<TDbContext>(DatabaseConfiguration dbConfiguration,
        ...
        public IServiceCollection AddDbContextConventionConfig<TConfig>()
        ...
        public IServiceCollection AddDbContextConfigurator<TConfig>()
        ...
        public EfDataServiceConfigurator AddEFCentralizedDataServices()
            => AddEFCentralizedDataServices(serviceCollection, null, null);

        public EfDataServiceConfigurator AddEFCentralizedDataServices(IConfiguration configuration)
        ...
        ///     The <see cref="EfDataServiceConfigurator"/> for chaining operations
        /// </returns>
        public EfDataServiceConfigurator AddEFCentralizedDataServices(DatabaseConfiguration dbConfiguration,
                                                                      IConfiguration        configuration)
        {
            ...
            {
                serviceCollection
                   .Configure<DataMigrationOptions>(configuration.GetSection(nameof(DataMigrationOptions)));
            }
    ...
    /// </param>
    extension(EfDataServiceConfigurator configurator)
    {
        /// <summary>
        ...
        ///     The <see cref="EfDataServiceConfigurator"/> for chaining operations
        /// </returns>
        public EfDataServiceConfigurator WithCentralizeDbContext<TDbContext>(
            Action<IServiceProvider, DbContextOptionsBuilder> configureAction)
            where TDbContext : DbContext
        {
            configurator.SharedDbContextOptionBuilder = configureAction;

            configurator.ServiceCollection.AddDbContext<TDbContext>((serviceProvider, configure) =>
            {
                configureAction?.Invoke(serviceProvider, configure);
        ...
        /// </typeparam>
        public EfDataServiceConfigurator UseCentralizedMigrationDbContext<TMigrationDbContext>()
    ...
    extension(IServiceCollection serviceCollection)
    {
        ...
        /// </typeparam>
        public IServiceCollection UseMigrationDbContext<TMigrationDbContext>(
        ...
        ///     The <see cref="DbContext" /> used for migrations
        /// </typeparam>
        public IServiceCollection UseDbContextWithMigration<TBaseDbContext, TMigrationDbContext>(
