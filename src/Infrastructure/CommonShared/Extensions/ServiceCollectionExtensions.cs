...
public static class ServiceCollectionExtensions
{
    ...
    extension(IServiceCollection serviceCollection)
    {
        ...
        /// <returns></returns>
        public IMvcBuilder AddCommonMvcApp(IConfiguration configuration = null)
        {
                                              ...
                                              .AddNewtonsoftJson(config =>
                                               {
                                                   ...
                                                   config.SerializerSettings.NullValueHandling =
        ...
        public void RegisterFilterProvider<T>()
        ...
        /// </returns>
        public CommonAppBuilder AddCommonWebAppServices(IConfiguration configuration)
        {
        ...
        public void AutoRegisterDependencyServices(Assembly[] loadedAssemblies)
        {
            ...
            foreach (var dependencyType in dependencyTypes)
            {
                ...
                interfaces = interfaces
                            .Except(interfaces.SelectMany(t => t.GetInterfaces().Where(t2 => !t2.IsGenericType)))
                            .ToArray();
