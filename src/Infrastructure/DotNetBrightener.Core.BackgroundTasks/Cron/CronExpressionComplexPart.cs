...
internal class CronExpressionComplexPart
{
    ...
    private static bool CheckIsSpecifiedInt(string expression, int toCheck)
    {
        ...
        if (!parsed)
        {
            throw new InvalidCronExpressionException($"Cron entry '{expression}' is malformed.");
        }
    ...
    private bool CheckRange(string expression, int toCheck)
    {
        ...
        {
            throw new InvalidCronExpressionException($"Cron expression ${expression} is malformed.");
        }
