...
public class FriendlyRouteActionSelector : IActionSelector
{
    ...
    public FriendlyRouteActionSelector(IActionDescriptorCollectionProvider actionDescriptorCollectionProvider,
                                       ILoggerFactory                      loggerFactory)
    {
        _actionDescriptorCollectionProvider = actionDescriptorCollectionProvider;
        _logger                             = loggerFactory.CreateLogger<FriendlyRouteActionSelector>();
    }
    ...
    public ActionDescriptor SelectBestCandidate(RouteContext context, IReadOnlyList<ActionDescriptor> candidates)
    {
        ...
        else
        {
            ...
            var message = "AmbiguousActions";
            //Microsoft.AspNetCore.Routing.Resources.FormatDefaultActionSelector_AmbiguousActions(
            //	Environment.NewLine,
            //	actionNames);
    ...
    private IReadOnlyList<ActionDescriptor> EvaluateActionConstraints(RouteContext                    context,
    ...
    private IReadOnlyList<ActionSelectorCandidate> EvaluateActionConstraintsCore(RouteContext context,
                                                                                 IReadOnlyList<
