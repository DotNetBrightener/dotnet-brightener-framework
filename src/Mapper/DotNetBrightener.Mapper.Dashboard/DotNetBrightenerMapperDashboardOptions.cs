...
/// <summary>
///     Configuration options for the DotNetBrightener Mapper Dashboard.
/// </summary>
public sealed class DotNetBrightenerMapperDashboardOptions
{
    /// <summary>
    ///     Gets or sets the route prefix for the dashboard. Default is "/dnb-mapper".
    /// </summary>
    public string RoutePrefix { get; set; } = "/dnb-mapper";

    /// <summary>
    ///     Gets or sets the title displayed in the dashboard. Default is "DotNetBrightener Mapper Dashboard".
    /// </summary>
    public string Title { get; set; } = "DotNetBrightener Mapper Dashboard";

    /// <summary>
    ///     Gets or sets whether to include system assemblies when discovering targets.
    ///     Default is false.
    /// </summary>
    public bool IncludeSystemAssemblies { get; set; } = false;

    /// <summary>
    ///     Gets or sets additional assemblies to scan for targets.
    /// </summary>
    public ICollection<System.Reflection.Assembly> AdditionalAssemblies { get; } =
