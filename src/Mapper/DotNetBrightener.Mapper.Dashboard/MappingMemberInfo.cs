...
/// <summary>
///     Represents information of a property or field on a type.
/// </summary>
public sealed class MappingMemberInfo
{
    ...
    /// <summary>
    ///     Gets whether this member maps to a nested target.
    /// </summary>
    ...
    /// <summary>
    ///     Creates a new instance of <see cref="MappingMemberInfo"/>.
    /// </summary>
    public MappingMemberInfo(
        string name,
        string typeName,
        bool isProperty,
        bool isNullable,
