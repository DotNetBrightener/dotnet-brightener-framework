...
///     <c>
///         ToTarget&lt;TSource, TTarget&gt;</c> to efficiently construct <typeparamref name="TTarget"/> instances
...
///         The target DTO or target type. Must expose either a public static <c>FromSource(<typeparamref name="TSource"/>)
///     </c>
...
/// </exception>
internal static class MappingCache<TSource, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods | DynamicallyAccessedMemberTypes.PublicConstructors)] TTarget>
    where TTarget : class
{
