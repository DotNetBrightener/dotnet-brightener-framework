...
/// <summary>
///     Extension methods for transforming LINQ expressions between source types and their target projections.
///     Enables reuse of business logic expressions across entities and DTOs.
/// </summary>
public static class MappingExpressionExtensions
{
    /// <summary>
    ///     Transforms a predicate expression from a source type to work with a Target type.
    /// </summary>
    /// <typeparam name="TTarget">
    ///     The Target type
    /// </typeparam>
    /// <param name="sourcePredicate">
    ///     The original predicate expression
    /// </param>
    /// <returns>
    ///     A transformed predicate that works with the target type
    /// </returns>
    /// <example>
    /// </example>
    public static Expression<Func<TTarget, bool>> MapToTarget<TTarget>(this LambdaExpression sourcePredicate)
        where TTarget : class
    {
    ...
    /// <summary>
    ///     Transforms a selector expression from a source type to work with a Target type.
    /// </summary>
    /// <typeparam name="TTarget">
    ///     The Target type
    /// </typeparam>
    /// <typeparam name="TResult">
    ///     The result type of the selector
    /// </typeparam>
    /// <param name="sourceSelector">
    ///     The original selector expression
    /// </param>
    /// <returns>
    ///     A transformed selector that works with the target type
    /// </returns>
    /// <example>
    ///     <code>
    ...
    ///     </code>
    /// </example>
    public static Expression<Func<TTarget, TResult>> MapToTarget<TTarget, TResult>(this LambdaExpression sourceSelector)
        where TTarget : class
    {
    ...
    /// <summary>
    ///     Transforms any lambda expression from a source type to work with a Target type.
    ...
    /// </param>
    /// <returns>
    ///     A transformed lambda expression that works with the target type
    /// </returns>
    /// <example>
    ///     <code>
    ///         Expression&lt;Func&lt;User, object&gt;&gt; sourceExpr = u => new { u.FirstName, u.Age };
    ///         Expression&lt;Func&lt;UserDto, object&gt;&gt; targetExpr = sourceExpr.MapToTargetGeneric&lt;UserDto&gt;();
    ///     </code>
    /// </example>
    public static LambdaExpression MapToTargetGeneric<TTarget>(this LambdaExpression sourceExpression)
        where TTarget : class
    {
    ...
    /// </summary>
    /// <typeparam name="T">
    ///     The input type for the predicates
    /// </typeparam>
    /// <param name="predicates">
    ///     The predicates to combine
    /// </param>
    /// <returns>
    ///     A single predicate expression that represents the AND of all input predicates
    /// </returns>
    public static Expression<Func<T, bool>> CombineWithAnd<T>(params Expression<Func<T, bool>>[] predicates)
    {
    ...
    /// </param>
    /// <returns>
    ///     A single predicate expression that represents the OR of all input predicates
    /// </returns>
    /// <example>
    ///     <code>
    ///         var predicate1 = (Expression&lt;Func&lt;User, bool&gt;&gt;)(u => u.IsVip);
    ///         var predicate2 = (Expression&lt;Func&lt;User, bool&gt;&gt;)(u => u.Age > 65);
    ///         var combined = MappingExpressionExtensions.CombineWithOr(predicate1, predicate2);
    ///         // Result: u => u.IsVip || u.Age > 65
    ///     </code>
    /// </example>
    public static Expression<Func<T, bool>> CombineWithOr<T>(params Expression<Func<T, bool>>[] predicates)
    {
        if (predicates == null) throw new ArgumentNullException(nameof(predicates));
    ...
    /// </param>
    /// <returns>
    ///     A predicate expression that represents the logical NOT of the input
    /// </returns>
    /// <example>
    ///     <code>
    ...
    ///     </code>
    /// </example>
    public static Expression<Func<T, bool>> Negate<T>(this Expression<Func<T, bool>> predicate)
    {
