...
internal class ParameterReplacer : ExpressionVisitor
{
    ...
    ///     The parameter to replace it with
    /// </param>
    ...
    ///     Dictionary mapping old parameters to new parameters
    /// </param>
    ...
    /// </param>
    /// <returns>
    ///     The replacement parameter if found, otherwise the original parameter
    /// </returns>
