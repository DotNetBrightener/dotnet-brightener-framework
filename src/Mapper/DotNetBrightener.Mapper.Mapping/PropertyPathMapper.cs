...
/// <summary>
///     Maps properties between source types and their target projections.
///     Handles both direct property mapping and custom property mappings defined in MappingTarget attributes.
/// </summary>
internal class PropertyPathMapper
{
    ...
    /// </param>
    /// <returns>
    ///     The corresponding target property, or null if no mapping exists
    /// </returns>
    ...
    ///     This attempts to match properties by name and type, with special handling for target projections.
    /// </summary>
