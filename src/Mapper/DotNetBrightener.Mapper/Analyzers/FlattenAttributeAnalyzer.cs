...
{
    // DNB014: Missing partial keyword
    ...
    // DNB017: LeafOnly naming collision warning
    public static readonly DiagnosticDescriptor LeafOnlyCollisionWarningRule = new(
                                                                                   "DNB017",
    ...
    private static void AnalyzeNamedType(SymbolAnalysisContext context)
    {
        ...
        var flattenAttributes = namedType.GetAttributes()
            .Where(attr => attr.AttributeClass?.ToDisplayString() == "DotNetBrightener.Mapper.FlattenAttribute")
            .ToList();
