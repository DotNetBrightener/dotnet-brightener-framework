...
{
    // DNB011: GenerateDtos on non-class type
    public static readonly DiagnosticDescriptor NonClassTypeRule = new(
                                                                       "DNB011",
    ...
    // DNB012: Invalid ExcludeProperties
    public static readonly DiagnosticDescriptor InvalidExcludePropertyRule = new(
                                                                                 "DNB012",
    ...
    // DNB013: DtoTypes.None specified
    public static readonly DiagnosticDescriptor NoDtoTypesRule = new(
                                                                     "DNB013",
    ...
    private static void AnalyzeNamedType(SymbolAnalysisContext context)
    {
        ...
        var dtoAttributes = namedType.GetAttributes()
            .Where(attr =>
                attr.AttributeClass?.ToDisplayString() == "DotNetBrightener.Mapper.GenerateDtosAttribute" ||
                attr.AttributeClass?.ToDisplayString() == "DotNetBrightener.Mapper.GenerateAuditableDtosAttribute")
            .ToList();
