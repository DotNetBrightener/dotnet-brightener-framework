...
{
    // DNB018: Missing partial keyword
    ...
    // DNB019: Invalid Exclude/Include property names
    ...
    // DNB021: Both Include and Exclude specified
    ...
    private static void AnalyzeNamedType(SymbolAnalysisContext context)
    {
        ...
        var wrapperAttributes = namedType.GetAttributes()
            .Where(attr => attr.AttributeClass?.ToDisplayString() == "DotNetBrightener.Mapper.WrapperAttribute")
            .ToList();
