...
internal static class AttributeProcessor
{
    ...
    /// </summary>
    public static List<string> ExtractCopiableAttributes(ISymbol member, TargetMemberKind targetKind)
    {
    ...
    ///     Filters out internal compiler attributes and non-copiable attributes.
    /// </summary>
    public static (List<string> attributes, HashSet<string> namespaces) ExtractCopiableAttributesWithNamespaces(ISymbol member, TargetMemberKind targetKind)
    {
        ...
        foreach (var attr in member.GetAttributes())
        {
            ...
            if (targetKind == TargetMemberKind.Property && !attributeTargets.HasFlag(AttributeTargets.Property)) continue;
            if (targetKind == TargetMemberKind.Field && !attributeTargets.HasFlag(AttributeTargets.Field)) continue;
    ...
    ///     code generation. Copying these to a generated target DTO would cause analyzer errors
