...
/// <summary>
///     Orchestrates the generation of complete target type source code.
/// </summary>
internal static class CodeBuilder
{
    /// <summary>
    ///     Generates the complete source code for a target type.
    /// </summary>
    public static string Generate(MappableTargetModel model, Dictionary<string, MappableTargetModel> targetLookup)
    {
        ...
        {
            ProjectionGenerator.GenerateProjectionProperty(sb, model, memberIndent, targetLookup);
        }
        ...
        {
            FlattenToGenerator.Generate(sb, model, memberIndent, targetLookup);
        }
    ...
    private static void GenerateFileHeader(StringBuilder sb)
    {
        ...
        sb.AppendLine($"//     This code was generated by the mapping target source generator v{Constants.GeneratorVersion}.");
    ...
    private static string GenerateContainingTypeHierarchy(StringBuilder sb, MappableTargetModel model)
    {
    ...
    private static void CloseContainingTypeHierarchy(StringBuilder sb, MappableTargetModel model, string containingTypeIndent)
    {
        // Close containing type braces
    ...
    private static string GetTypeKeyword(MappableTargetModel model)
    {
    ...
    private static void GeneratePositionalDeclaration(StringBuilder sb, MappableTargetModel model, string keyword, string indent)
    {
