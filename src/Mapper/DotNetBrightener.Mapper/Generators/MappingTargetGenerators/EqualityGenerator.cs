...
/// <summary>
///     Generates value-based equality members (Equals, GetHashCode, ==, !=) for target types.
/// </summary>
internal static class EqualityGenerator
{
    ...
    /// </summary>
    public static string GetEquatableInterface(MappableTargetModel model)
    {
        return $"System.IEquatable<{model.Name}>";
    }

    private static void GenerateEqualsT(StringBuilder sb, MappableTargetModel model, string indent)
    {
        sb.AppendLine();
    ...
    private static void GenerateEqualsObject(StringBuilder sb, MappableTargetModel model, string indent)
    {
        sb.AppendLine();
    ...
    private static void GenerateGetHashCode(StringBuilder sb, MappableTargetModel model, string indent)
    {
        sb.AppendLine();
        sb.AppendLine($"{indent}/// <inheritdoc/>");
    ...
    private static void GenerateEqualityOperators(StringBuilder sb, MappableTargetModel model, string indent)
    {
        bool isClass = model.TypeKind == Microsoft.CodeAnalysis.TypeKind.Class;
    ...
    private static string GetEqualityExpression(MappableTargetMember member)
    {
    ...
    private static string GetHashCodeExpression(MappableTargetMember member)
    {
        if (member.IsValueType)
        {
