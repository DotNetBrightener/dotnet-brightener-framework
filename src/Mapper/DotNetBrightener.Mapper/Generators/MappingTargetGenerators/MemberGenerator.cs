...
/// <summary>
///     Generates member declarations (properties and fields) for mapping target types.
/// </summary>
internal static class MemberGenerator
{
    ...
    /// </summary>
    public static void GenerateMembers(StringBuilder sb, MappableTargetModel model, string memberIndent)
    {
        ...
        foreach (var m in model.Members)
        {
            ...
            if (m.Kind == TargetMemberKind.Property)
            {
    ...
    private static void GenerateProperty(StringBuilder sb, MappableTargetMember member, string indent)
    {
    ...
    private static void GenerateField(StringBuilder sb, MappableTargetMember member, string indent)
    {
