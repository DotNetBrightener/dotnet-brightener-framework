...
/// <summary>
///     Generates ToSource methods for converting target instances back to their source types.
/// </summary>
internal static class ToSourceGenerator
{
    /// <summary>
    ///     Generates the ToSource and BackTo methods that convert the target type back to the source type.
    /// </summary>
    public static void Generate(StringBuilder sb, MappableTargetModel model)
    {
    ...
    private static void GeneratePositionalToSource(StringBuilder sb, MappableTargetModel model)
    {
    ...
    private static void GenerateObjectInitializerToSource(StringBuilder sb, MappableTargetModel model)
    {
