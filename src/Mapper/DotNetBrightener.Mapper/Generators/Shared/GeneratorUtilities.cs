...
/// <summary>
///     Shared utility methods for mapping target source generators.
/// </summary>
internal static class GeneratorUtilities
{
    ...
    ///     The type symbol to get the name from.
    /// </param>
    /// <returns>
    ///     A fully qualified type name with nullability annotations.
    /// </returns>
    ...
    /// </summary>
    /// <param name="type">
    ///     The type symbol to get members from.
    /// </param>
    /// <returns>
    ///     An enumerable of tuples containing the symbol, init-only flag, and required flag.
    /// </returns>
    ...
    /// </summary>
    /// <param name="typeName">
    ///     The fully qualified or simple type name.
    /// </param>
    /// <returns>
    ...
    /// </summary>
    /// <param name="typeName">
    ///     The type name to make nullable.
    /// </param>
    /// <returns>
    ///     The nullable version of the type name.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    ///     A C# expression string representing the default value.
    /// </returns>
    ...
    ///     The extracted element type symbol if successful.
    /// </param>
    /// <param name="collectionWrapper">
    ///     The collection type wrapper (e.g., "List", "ICollection", "IReadOnlyList", "array").
    /// </param>
    /// <returns>
    ...
    /// </param>
    /// <returns>
    ///     True if the underlying type is nested within another type; otherwise, false.
    /// </returns>
    ...
    /// </param>
    /// <param name="collectionWrapper">
    ///     The collection wrapper type ("List", "ICollection", "IList", "IEnumerable", "IReadOnlyList", "IReadOnlyCollection", "array").
    /// </param>
    /// <returns>
    ///     The fully qualified collection type name.
    /// </returns>
