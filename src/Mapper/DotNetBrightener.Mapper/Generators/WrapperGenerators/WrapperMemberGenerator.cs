...
internal static class WrapperMemberGenerator
{
    ...
    private static void GenerateMember(StringBuilder sb, WrapperTargetModel model, MappableTargetMember member, string indent)
    {
        ...
        else if (member.Kind == TargetMemberKind.Field)
        {
            GenerateDelegatingField(sb, model, member, indent);
        }
    }

    private static void GenerateDelegatingProperty(StringBuilder sb, WrapperTargetModel model, MappableTargetMember member, string indent)
    {
    ...
    private static void GenerateDelegatingField(StringBuilder sb, WrapperTargetModel model, MappableTargetMember member, string indent)
    {
