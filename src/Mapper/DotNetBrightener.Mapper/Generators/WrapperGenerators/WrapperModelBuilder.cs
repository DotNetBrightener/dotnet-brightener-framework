...
internal static class WrapperModelBuilder
{
    ...
    public static WrapperTargetModel? BuildModel(GeneratorAttributeSyntaxContext context, CancellationToken token)
    {
        ...
        var readOnly = AttributeParser.GetNamedArg(attribute.NamedArguments, Constants.AttributeNames.ReadOnly, false);
    ...
    private static ImmutableArray<MappableTargetMember> ExtractMembers(
