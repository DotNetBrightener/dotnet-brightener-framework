...
internal sealed class MappableTargetMember : IEquatable<MappableTargetMember>
{
    public string Name { get; }
    public string TypeName { get; }
    public TargetMemberKind Kind { get; }
    public bool IsValueType { get; }
    public bool IsInitOnly { get; }
    public bool IsRequired { get; }
    public bool IsReadOnly { get; }
    public string? XmlDocumentation { get; }
    public bool IsNestedTarget { get; }
    public string? NestedTargetSourceTypeName { get; }
        ...
        bool isPartial = false)
    {
        ...
        NestedTargetSourceTypeName = nestedTargetSourceTypeName;
    ...
    public bool Equals(MappableTargetMember? other) =>
        other is not null &&
        Name == other.Name &&
        ...
        IsNestedTarget == other.IsNestedTarget &&
        NestedTargetSourceTypeName == other.NestedTargetSourceTypeName &&
    ...
    public override bool Equals(object? obj) => obj is MappableTargetMember other && Equals(other);
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            ...
            hash = hash * 31 + IsNestedTarget.GetHashCode();
            hash = hash * 31 + (NestedTargetSourceTypeName?.GetHashCode() ?? 0);
