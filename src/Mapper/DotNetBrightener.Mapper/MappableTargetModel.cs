...
internal sealed class MappableTargetModel : IEquatable<MappableTargetModel>
{
    ...
    public ImmutableArray<MappableTargetMember> Members { get; }
    ...
    public ImmutableArray<MappableTargetMember> ExcludedRequiredMembers { get; }
    ...
    /// <summary>
    ///     Whether to generate a copy constructor that accepts another instance of the same target type.
    /// </summary>
    ...
    public MappableTargetModel(
        ...
        ImmutableArray<MappableTargetMember> excludedRequiredMembers = default,
        ...
        bool generateEquality = false)
    {
        ...
        ExcludedRequiredMembers = excludedRequiredMembers.IsDefault ? ImmutableArray<MappableTargetMember>.Empty : excludedRequiredMembers;
    ...
    public bool Equals(MappableTargetModel? other)
    {
    ...
    public override bool Equals(object? obj) => obj is MappableTargetModel other && Equals(other);
    ...
    internal static IEqualityComparer<MappableTargetModel> Comparer { get; } = new TargetModelEqualityComparer();

    internal sealed class TargetModelEqualityComparer : IEqualityComparer<MappableTargetModel>
    {
        public bool Equals(MappableTargetModel? x, MappableTargetModel? y) => x?.Equals(y) ?? y is null;
        public int GetHashCode(MappableTargetModel obj) => obj.GetHashCode();
    }
}
