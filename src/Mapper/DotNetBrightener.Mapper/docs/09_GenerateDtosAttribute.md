...
The `Optional<T>` type is a struct that wraps values and tracks whether they've been explicitly set. It's part of the `DotNetBrightener.Mapper` namespace and available for use in your own code.
...
See [MappingTarget Attribute Reference](03_AttributeReference.md) for the basic `[MappingTarget<TSource>]` attribute documentation.
