...
// Target for ExtendedEntity
[MappingTarget<ExtendedEntity>()]
public partial class ExtendedTarget;

// Target for DataEntity with FlattenTo
[MappingTarget<DataEntity>( NestedTargetTypes = [typeof(ExtendedTarget)], FlattenTo = [typeof(DataFlattenedDto)])]
...
// The FlattenTo method will populate these from DataTarget (parent) and each Extended item (child)
...
// Test models for FlattenTo with lookup/junction tables and nested targets
...
// Targets
[MappingTarget<DataExtendedEntity>()]
public partial class DataExtendedTarget;

[MappingTarget<DataExtendedLookupEntity>(
    NestedTargetTypes = [typeof(DataExtendedTarget)])]
public partial class DataExtendedLookupTarget;

[MappingTarget<DataTableEntity>(
    NestedTargetTypes = [typeof(DataExtendedLookupTarget)],
    FlattenTo = [typeof(DataTableFlattenedDto)])]
public partial class DataTableTarget;
...
// Targets for SmartLeaf collision test
[MappingTarget<CategoryEntity>()]
public partial class CategoryTarget;

[MappingTarget<SupplierEntity>()]
public partial class SupplierTarget;

[MappingTarget<BrandEntity>()]
public partial class BrandTarget;

[MappingTarget<ProductLookupEntity>(
    NestedTargetTypes = [typeof(CategoryTarget), typeof(SupplierTarget), typeof(BrandTarget)])]
public partial class ProductLookupTarget;

[MappingTarget<ProductCatalogEntity>(
    NestedTargetTypes = [typeof(ProductLookupTarget)],
    FlattenTo = [typeof(ProductCatalogFlattenedDto)])]
public partial class ProductCatalogTarget;
