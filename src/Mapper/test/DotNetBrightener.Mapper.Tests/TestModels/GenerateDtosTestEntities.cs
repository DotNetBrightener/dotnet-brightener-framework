...
[GenerateDtos(Types = DtoTypes.Create, OutputType = OutputType.Class, ExcludeProperties = ["SecretKey"])]
[GenerateDtos(Types = DtoTypes.Response, OutputType = OutputType.Class, ExcludeProperties = ["SecretKey", "InternalData"
              ])]
...
public class TestComplexTypes
{
    ...
    public TestNestedType[]           ArrayProperty { get; set; } = [];
}
