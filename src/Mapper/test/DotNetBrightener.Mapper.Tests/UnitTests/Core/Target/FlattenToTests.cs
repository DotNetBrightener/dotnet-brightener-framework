...
public class FlattenToTests
{
    ...
    public void FlattenTo_ShouldCombineParentAndCollectionItemProperties()
    {
        ...
        var target = new DataTarget(data);

        // Act
        var flattened = target.FlattenTo();
    ...
    [Fact]
    public void FlattenTo_WithNestedTargetsInLookupTable_ShouldFlattenThroughNestedNavigation()
    {
        ...
        var target = new TestModels.DataTableTarget(data);
    ...
    public void FlattenTo_WithMultipleNameCollisions_ShouldUseSmartLeafNaming()
    {
        ...
        var target = new TestModels.ProductCatalogTarget(catalog);
