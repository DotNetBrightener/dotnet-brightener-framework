...
public partial class BasicWrapperTests
{
    ...
    public void Wrapper_Should_Delegate_To_Source_Object()
    {
        ...
        wrapper.FirstName.ShouldBe("John");
        wrapper.LastName.ShouldBe("Doe");
        wrapper.Email.ShouldBe("john@example.com");
    }
    ...
    public void Wrapper_Should_Propagate_Changes_To_Source()
    {
        ...
        // Assert
        user.FirstName.ShouldBe("Jane", "changes to wrapper should affect source");
        user.Email.ShouldBe("jane@example.com", "changes to wrapper should affect source");
    }
    ...
    public void Wrapper_Unwrap_Should_Return_Source_Object()
    {
        ...
        // Assert
        unwrapped.ShouldBeSameAs(user, "Unwrap should return the original source object");
    }
