...
[Wrapper(typeof(Person), "SocialSecurityNumber", NestedWrappers = [typeof(PublicAddressWrapper)])]
...
public partial class NestedWrapperTests
{
    ...
    public void Nested_Wrapper_Should_Wrap_Nested_Properties()
    {
        ...
        wrapper.Name.ShouldBe("John Doe");
        wrapper.Address.ShouldNotBeNull();
        wrapper.Address.Street.ShouldBe("123 Main St");
        wrapper.Address.City.ShouldBe("Springfield");
        wrapper.Address.ZipCode.ShouldBe("12345");

        // Country should be excluded by PublicAddressWrapper
        wrapper.Address.GetType().GetProperty("Country").ShouldBeNull();
    }
    ...
    public void Nested_Wrapper_Changes_Should_Propagate_To_Source()
    {
        ...
        // Assert
        person.Address.City.ShouldBe("New York");
    }
    ...
    public void Nested_Wrapper_Should_Unwrap_Correctly()
    {
        ...
        // Assert
        unwrapped.ShouldBeSameAs(person);
        unwrapped.Address.City.ShouldBe("Seattle");
    }
